...
# model_ = '/home/xwang1/livertox_extension/model/finetuned_BERT'
...
def train_model(datapath,model_name_or_path,save_model_path, epochs):
    ...
    PATH = save_model_path + model_name_or_path
...
def test_model(datapath,model_name, PATH, PATH2):
    pretrain_model_name = 'bert-base-cased'
    print('Loading tokenizer...')
    tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path=pretrain_model_name)

    test_dataset = Dataset(path=datapath+'all.tsv',
                                        use_tokenizer=tokenizer,
                                        labels_ids=labels_ids,
                                        max_sequence_len=max_length)
    ...
    model.eval()
    logits_list=test(test_dataloader, model, device)
...
PATH = '/home/xwang1/livertox_extension_codine/finetuned_model/'
PATH2 = '/home/xwang1/livertox_extension_codine/causal_inference_set/'
datapath = '/home/xwang1/livertox_extension_codine/codine/'
epochs = 20
